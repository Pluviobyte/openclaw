...
async function readProjectedChatHistoryPageAsync(params: {
  ...
  if (typeof params.beforeSeq !== "number") {
    ...
    const filteredRecentMessages = dropPreSessionStartAnnouncePairs(
      recent.messages,
      sessionStartedAt,
    );
    let projected = augmentChatHistoryWithCanvasBlocks(
      projectRecentChatDisplayMessages(filteredRecentMessages, {
        maxChars: params.effectiveMaxChars,
      }),
    );
    ...
    if (
      ...
      const filteredBroaderRecentMessages = dropPreSessionStartAnnouncePairs(
        broaderRecent.messages,
        sessionStartedAt,
      );
      projected = augmentChatHistoryWithCanvasBlocks(
        projectRecentChatDisplayMessages(filteredBroaderRecentMessages, {
          maxChars: params.effectiveMaxChars,
        }),
      );
  ...
  const projected = augmentChatHistoryWithCanvasBlocks(
    projectRecentChatDisplayMessages(
      dropPreSessionStartAnnouncePairs(localMessagesReversed.reverse(), sessionStartedAt),
      {
        maxChars: params.effectiveMaxChars,
      },
    ),
